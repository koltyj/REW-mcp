...
- Tightened the npm package contents to ship only public-facing documentation.
- Updated the public docs to match the current tool and resource surface.
- Migrated ESLint to flat config format (ESLint v10 compatibility).
